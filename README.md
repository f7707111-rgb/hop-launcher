...
Вставляй именно как есть — ссылки уже оформлены в виде слов-гиперссылок (markdown), GitHub отрендерит их кликабельными автоматически. После вставки текста нажми **Commit changes**.
```
